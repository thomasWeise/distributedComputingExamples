...
The complex number [calculator](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/java/calculator/Calculator.java) web service offers methods to add, subtract, multiply, and divide [complex numbers](https://en.wikipedia.org/wiki/Complex_number). We therefore introduce a new [data type](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/java/calculator/Complex.java) for representing a complex number in form of a [JavaBean](https://en.wikipedia.org/wiki/JavaBeans). If the bean is mapped to a namespace URI in the [`services.xml`](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/resources/META-INF/services.xml) file, it can be used as parameter and return value of the service routines, i.e., our service can receive and respond with complex Java objects. The web service is otherwise structured in exactly the same way as our warehouse web service.

1. [`Calculator.java`](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/java/calculator/Calculator.java)
1. [`Complex.java`](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/java/calculator/Complex.java)
1. [`services.xml`](http://github.com/thomasWeise/distributedComputingExamples/tree/master/webServices/examples/calculator/server/src/main/resources/META-INF/services.xml) 
